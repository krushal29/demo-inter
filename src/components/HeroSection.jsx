          ...
          <div className="w-1/2">
            ...
            <div className="py-5 border-b border-[#d9d9d9] dark:border-gray-700">
              <div className="flex space-x-3 items-center">
                ...
                <p className="text-[#ff4444] dark:text-white text-xs font-semibold">30% OFF</p>
              </div>
              <div>
                ...
                {materialOptions.map((material, index) => (
                  <button
                    ...
                    className={`text-sm font-bold rounded-[5px] px-3 py-2 cursor-pointer ${
                      selectedMaterial === material ? "bg-black text-white dark:bg-black dark:text-white" : "bg-gray-200 text-gray-700 dark:bg-[#1b1b1e] dark:text-white"
                    }`}
              ...
              <div className="flex space-x-3 mt-2 flex-wrap">
                {sizeOptions.map((size, index) => (
                  <button
                    key={index}
                    className={`text-sm font-bold rounded-[5px] px-3 py-2 cursor-pointer ${
                      selectedSize === size ? "bg-black text-white dark:bg-black dark:text-white" : "bg-gray-200 text-gray-700 dark:bg-[#1b1b1e] dark:text-white"
                    }`}
            ...
            <div className="py-5">
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  ...
                  <p className="text-[#ff4444] dark:text-white text-xs pl-4 font-semibold">Tool free option</p>
                </div>
                <IoMdInformationCircleOutline />
              </div>
              <div className="flex space-x-3 mt-2 flex-wrap">
            ...
            <div className="flex flex-col gap-2 mt-3">
              <div className="flex items-center gap-4 w-full">
                <div className="flex items-center border rounded-lg overflow-hidden w-1/3 dark:border-gray-700">
                  <button className="px-4 py-2 text-lg font-bold hover:bg-gray-100 dark:hover:bg-[#1b1b1e] dark:text-white" onClick={handleQuantityDecrease}>
                    −
                  </button>
                  <span className="px-6 py-2 font-semibold">{quantity}</span>
                  <button className="px-4 py-2 text-lg font-bold hover:bg-gray-100 dark:hover:bg-[#1b1b1e] dark:text-white" onClick={handleQuantityIncrease}>
                    +
                  </button>
                </div>
