...
const Navbar = () => {
  return (
    <div className="fixed top-8 left-0 w-full border-b bg-white z-40">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <nav className="hidden lg:flex flex-grow justify-center">
          <ul className="flex items-center space-x-10 font-semibold text-sm tracking-wider text-gray-800">
            ...
            <li>
              <Link href="#" aria-label="Special Offers">
                <BsSnow className="h-5 w-5 text-gray-700 hover:text-blue-500 transition-colors" />
              </Link>
            </li>
          </ul>
        </nav>
        ...
        <div className="flex items-center space-x-4">
          <button className="p-2.5 bg-gray-100 rounded-full hover:bg-gray-200 transition-colors" aria-label="Search">
            <CiSearch size={22} className="text-gray-700" />
          </button>
          <Link href="/account" aria-label="My Account">
            <CiUser size={28} className="text-gray-700 hover:text-purple-600 transition-colors" />
          </Link>
          <button className="border border-gray-300 rounded-full px-5 py-2 text-sm font-bold text-gray-800 hover:bg-gray-50 hover:border-gray-400 transition-colors">
            £0.00
          </button>
        </div>
      </div>
